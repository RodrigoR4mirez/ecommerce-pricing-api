package com.inditex.pricing.ecommercepricingapi;
...
public final class Constants {
    ...
    public static final String LOG_FETCH_PRICES =
            "Fetching prices for brandId={} productId={}";
    public static final String LOG_REQUEST_PRICES =
            "Received prices request brandId={} productId={}";
    ...
    public static final String QUERY_FIND_APPLICABLE_PRICES =
            "SELECT p FROM PriceJpaEntity p WHERE p.brandId = :brandId AND p.productId = :productId " +
    ...
    public static final String QUERY_FIND_ALL_PRICES =
            "SELECT p FROM PriceJpaEntity p WHERE p.brandId = :brandId AND p.productId = :productId ORDER BY p.startDate";

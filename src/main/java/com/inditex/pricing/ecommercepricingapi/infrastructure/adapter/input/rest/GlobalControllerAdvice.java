...
import static com.inditex.pricing.ecommercepricingapi.utils.Constants.INVALID_PARAMETER;
import static com.inditex.pricing.ecommercepricingapi.utils.Constants.RESOURCE_NOT_FOUND;
import static com.inditex.pricing.ecommercepricingapi.utils.Constants.VALIDATION_FAILED;
...
public class GlobalControllerAdvice {
  ...
  public ResponseEntity<ErrorResponse> handlePriceNotFound(PriceNotFoundException ex) {
    ...
    ErrorResponse error = new ErrorResponse(String.valueOf(HttpStatus.NOT_FOUND.value()),
        RESOURCE_NOT_FOUND, List.of(ex.getMessage()));
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
    ...
    ErrorResponse error = new ErrorResponse(
        String.valueOf(HttpStatus.BAD_REQUEST.value()), VALIDATION_FAILED, details);
  ...
  public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
    ...
    ErrorResponse error = new ErrorResponse(String.valueOf(HttpStatus.BAD_REQUEST.value()),
        VALIDATION_FAILED, List.of(detail));
    return ResponseEntity.badRequest().body(error);
  }
  ...
  public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
    ...
    ErrorResponse error = new ErrorResponse(String.valueOf(
        HttpStatus.INTERNAL_SERVER_ERROR.value()), Constants.INTERNAL_ERROR,
